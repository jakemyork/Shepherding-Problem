...
figure(1);
scatter(sheepMatrix(:,x),sheepMatrix(:,y),circleSize,'filled');
hold on; scatter(shepherdPos(x),shepherdPos(y),'p');
...
for timesteps = 1:1000
    ...
    % create inputs to the neural networks
...
writerObj = VideoWriter('fullSimOriginal.avi');
